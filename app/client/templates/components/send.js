...
// Set basic variables
Template['components_send'].onCreated(function(){
    var template = this;
...
Template['components_send'].onRendered(function(){
    var template = this;
...
Template['components_send'].helpers({
    /**
    ...
    */
    'formattedCoinBalance': function(e){
        var selectedAccount = Helpers.getAccountByAddress(TemplateVar.getFrom('.dapp-select-account', 'value'), true);
...
Template['components_send'].events({
    /**
    Send all funds
